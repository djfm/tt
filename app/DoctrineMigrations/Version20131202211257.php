 ...
 */
class Version20131202211257 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE Translation (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, locale VARCHAR(64) NOT NULL, plurality INT NOT NULL, msgstr LONGTEXT DEFAULT NULL, INDEX IDX_32F5CAB8A76ED395 (user_id), INDEX TranslationIdAndPlurality (id, plurality), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE Context (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, name VARCHAR(64) NOT NULL, INDEX IDX_2DE0BCE2166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Domain (id INT AUTO_INCREMENT NOT NULL, project_id INT DEFAULT NULL, name VARCHAR(64) NOT NULL, INDEX IDX_A0051B3D166D1F9C (project_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        $this->addSql("CREATE TABLE Pack (id INT AUTO_INCREMENT NOT NULL, project_id INT NOT NULL, user_id INT DEFAULT NULL, name VARCHAR(256) DEFAULT NULL, version VARCHAR(64) DEFAULT NULL, INDEX IDX_37ECF11D166D1F9C (project_id), INDEX IDX_37ECF11DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("CREATE TABLE Mapping (id INT AUTO_INCREMENT NOT NULL, message_id INT DEFAULT NULL, translation_id INT DEFAULT NULL, plurality INT NOT NULL, user_id INT DEFAULT NULL, INDEX IDX_865B1516537A1329 (message_id), INDEX IDX_865B15169CAA2B25997AA24A (translation_id, plurality), INDEX IDX_865B1516A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE PackMessage DROP FOREIGN KEY FK_211FD4971919B217");
        ...
        $this->addSql("ALTER TABLE PackMessage DROP FOREIGN KEY FK_211FD497537A1329");
        ...
        $this->addSql("ALTER TABLE MappingComment DROP FOREIGN KEY FK_8B2D4611FABB77CC");
        $this->addSql("ALTER TABLE MappingFlag DROP FOREIGN KEY FK_43CD8FF6FABB77CC");
